...
; KEYWORD PARAMETERS:
;       Keywords:
;         /NEWS Allow N, E, W, S in strings to indicate hemisphere.
;           S or W give values < 0.
;           Allows values like:'-33 27 15.2','33 27 15.2 S','S33 27 15.2','S 33 27 15.2',
...
;       R. Sterner, 2010 Jan 19 --- Added /NEWS keyword.
;
...
;-
;-------------------------------------------------------------
	function dms2d, in0, news=news, help=hlp
	...
	if (n_params(0) lt 1) or keyword_set(hlp) then begin
	  ...
	  print,' Keywords:'
	  print,'   /NEWS Allow N, E, W, S in strings to indicate hemisphere.'
	  print,'     S or W give values < 0.'
	  print,"     Allows values like:'-33 27 15.2','33 27 15.2 S','S33 27 15.2','S 33 27 15.2',"
