...
;       R. Sterner, 1999 Jun 7 Written as showbits.pro.
;       R. Sterner, 2011 Aug 25 --- Renamed to bit_show.pro.
;       R. Sterner, 2011 Aug 25 --- Updated () to [] for arrays.
;
...
;-
;-------------------------------------------------------------
	pro bit_show, v, group=g, help=hlp, out=out, n=new, $
	...
	if (n_params(0) lt 1) or keyword_set(hlp) then begin
	  ...
	  return
        ...
        if bits le 0 then begin
          print,' Error in bit_show: Input must be an integer data type.'
          return
        endif
