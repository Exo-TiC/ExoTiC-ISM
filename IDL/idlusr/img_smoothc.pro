...
;       R. Sterner, 2014 Jul 28 --- Added /CONE and KERNEL=k.
;
...
;-------------------------------------------------------------
	function img_smoothc, img, sm, width=width, error=err, $
	  zero=zero, cone=cone, kernel=k, help=hlp
	...
	if (n_params(0) lt 1) or keyword_set(hlp) then begin
      ...
      print,'     0.25 is a good value for the gaussian smoothing.'
      print,'     1.00 is a good value for the cone smoothing.'
      ...
      print,'   /CONE Use a cone insted of a gaussian.'
      print,'   KERNEL=k Return kernel used in k.'
