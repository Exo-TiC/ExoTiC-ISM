...
;-
;-------------------------------------------------------------
	pro ell_geo_int, s1, s2, pm, flag=flag, nosearch=nosrch, help=hlp
	...
	if (n_params(0) lt 3) or keyword_set(hlp) then begin
	  ...
	  print,'   /NOSEARCH  Do not search for intersection point.'
	  print,'     Just return status flag.'
	  return
	endif
	...
	if keyword_set(nosrch) then return	; No search.
