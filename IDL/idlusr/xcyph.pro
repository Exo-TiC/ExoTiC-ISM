...
;         XSIZE=xsz Slider length (pix).  Def=400.
...
;       R. Sterner, 2008 Oct 08 --- Added XSIZE=xsz.
;
...
;==============================================
	...
	pro xcyph, data, time, range=ran, cpout=cpout, tout=tout, $
	  slice=slice, offset=offset, xsize=xsz, help=hlp
	...
	if (n_params(0) lt 2) or keyword_set(hlp) then begin
	  ...
	  print,'   XSIZE=xsz Slider length (pix).  Def=400.'
	...
	if n_elements(xsz) eq 0 then xsz=400
	...
	ids = widget_slider(bb,uval='SLIDE',xsize=xsz, $
