...
;
; color: 55
;     May give plot color here.  Remember the curve is plotted using
;     XOR mode.  So if the background color is 23 and the desired plot
;     color is 32 then use 55 since 32 = 23 XOR 55.  The default should
