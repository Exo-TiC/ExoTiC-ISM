...
;-------------------------------------------------------------
	...
	if (n_params(0) lt 2) or keyword_set(hlp) then begin
	  ...
	  print,'     transparency of the same size on top of it.'
          print,'     May also be an 8-bit B&W byte image or a 2-d floating'
          print,'     point array with values from 0 to 1 (make sure to cover'
          print,'     the range 0 to 1 if floating for best results).'
	...
	img_split, filt, r2, g2, b2, true=trf,nx=nx2, ny=ny2
	...
	;-----  Compute filter transmission factors  --------
        if datatype(r2) eq 'BYT' then begin
	  r2tr = r2/255.
	  g2tr = g2/255.
	  b2tr = b2/255.
        endif else begin
