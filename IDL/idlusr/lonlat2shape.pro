...
;-------------------------------------------------------------
	...
	if (n_params(0) lt 3) or keyword_set(hlp) then begin
	  ...
	  print,'   filename = Name of new shapefile. in'
	  print,'      Note: Any file extension gets dropped.'
	  print,'      To avoid add a dummy extension.'
	  return
	endif
	...
	filebreak,filename,noext=noext
	print,' Shape file complete: '+noext+'.*'
