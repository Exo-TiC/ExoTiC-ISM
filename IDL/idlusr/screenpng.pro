...
;-------------------------------------------------------------
	pro screenpng, file, posx, posy, window=outwin, error=err, image=img, $
	  ...
	  info=info, noswin=noswin, map_set=mset
	...
	if keyword_set(hlp) then begin
	  ...
	  print,'   INFO=info Returned embedded map scaling info if any.'
          print,'   /MAP_SET Use embedded set_scale info as map scaling info.'
          print,'     Only useful if image is a map.  Will replace embedded'
          print,'     info with embedded map info (set map_set will work).'
	...
	set_scale, image=img0, /quiet, mag=mag, map_set=mset ; Set scale.
