...
; KEYWORD PARAMETERS:
;       Keywords:
;         /SPACE Add a space after the commas in the list.
...
;       R. Sterner, 2014 Jul 31 --- Added /SPACE keyword.
;
...
;-
;-------------------------------------------------------------
	function commalist, arr, fmt, nocommas=nocom0, delimiter=del, $
        space=space, help=hlp
	...
	if (n_params(0) lt 1) or keyword_set(hlp) then begin
	  ...
	  print,' Keywords:'
      print,'   /SPACE Add a space after the commas in the list.'
