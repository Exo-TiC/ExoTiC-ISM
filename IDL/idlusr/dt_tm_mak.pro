...
;       R. Sterner, 2014 Feb 06 --- Kept eps at 0, was getting bad fraction.
;         Thought it was needed in sechms but tested all seconds of the day and
;         not needed even for single precision.
;
...
;	  eps = 10.D0^(-dec-1)			; Eps for sechms.
	endif
...
;-------------------------------------------------------------------------
	...
	sechms, rem,h,m,s,hh,mm,ss,frac=frac,eps=eps  ; Find Hr, Min, Sec.
