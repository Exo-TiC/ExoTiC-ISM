...
;-------------------------------------------------------------
	...
	txt = 'Hex: '+string([r,g,b],form='(3Z2.2)')
	widget_control, s.id_hex, set_val=txt
	;------  Update color patch  -------------------
	wset, s.win_new
	...
	b = widget_base(right,/col)
	id_rgb = widget_label(b,val='RGB: 000, 000, 000',/dynamic,/align_left)
	id_hsv = widget_label(b,val='HSV: 000, 0.00, 0.00',/dynamic,/align_left)
	id_c24 = widget_label(b,val='C24: 0',/dynamic,/align_left)
	id_hex = widget_label(b,val='Hex: 000000',/dynamic,/align_left)
	...
	s = {win_whl:win_whl, win_bar:win_bar, win_new:win_new, id_hex:id_hex, $
