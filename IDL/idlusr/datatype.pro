...
;-------------------------------------------------------------
	...
	if (n_params(0) lt 1) or keyword_set(hlp) then begin
	  ...
	  print,'      UND       Undefined   0         UND          UND'
	  print,'      BYT       Byte        1         BYT          B'
	  print,'      INT       Integer     2         INT          I'
	  print,'      LON       Long        3         LON          L'
	  print,'      FLO       Float       4         FLT          F'
	  print,'      DOU       Double      5         DBL          D'
	  print,'      COM       Complex     6         COMPLEX      C'
	  print,'      STR       String      7         STR          S'
	  print,'      STC       Structure   8         STC          STC'
	  print,'      DCO       DComplex    9         DCOMPLEX     DC'
	  print,'      PTR       Pointer    10         PTR          PTR'
	  print,'      OBJ       Object     11         OBJ          OBJ'
	  print,'      UIN       U_Integer  12         UINT         UI'
	  print,'      ULO       U_Long     13         ULON         UL'
	  print,'      LLO       Long_64    14         LON64        L64'
	  print,'      ULL       U_Long_64  15         ULON64       UL64'
	  print,' Keywords:'
  ...
  15:       typ = 'ULON64'
	  ...
	  endcase
	endif else if flag eq 4 then begin
	  case styp of
   0:	    typ = 'UND'
   1:       typ = 'B'
   2:       typ = 'I'
