...
;===============================================================
	...
	;--------  List or file name of list?  ------
	if n_elements(list0) eq 1 then begin	; Assume file name of list.
	  filebreak,list0,dir=dir0		; Directory of list file.
	  list = getfile(list0,err=err,/quiet)	; Read list file.
	endif else begin			; Assume actual list.
	  list = list0				; Just copy given list.
	endelse
	...
	for i = 0, n-1 do begin			; Loop through given files.
	  ...
	  if dir eq '' then dir=dir0		; Assume with list file.
