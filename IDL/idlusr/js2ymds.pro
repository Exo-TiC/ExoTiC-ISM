...
;       R. Sterner, 2014 Feb 24 --- 1 element js array now returns scalars.
;
...
;-------------------------------------------------------------
	...
	pro js2ymds, js0, y, m, d, s, t2, t3, help=hlp
	...
	if (n_params(0) lt 4) or keyword_set(hlp) then begin
	  ...
	  return
        ...
        njs = n_elements(js0)           ; Number of times.
        if njs eq 1 then js=js0[0] else js=js0  ; Force 1 element arrays scalar.
