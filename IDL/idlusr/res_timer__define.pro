	;===========================================================
	;  res_timer__define.pro = Timer object
	...
	pro res_timer::time, text=txt, out=out, fraction=frac, quiet=quiet
	...
	function res_timer::init, text=txt
