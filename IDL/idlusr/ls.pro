...
;       R. Sterner, 2011 Dec 08 --- Added ERROR=err. alo,ahi=-1 for constant.
;
...
;-------------------------------------------------------------
	...
	if (np lt 1) or keyword_set(hlp) then begin
	  ...
	  print,'   /NOSCALE  Do not actually scale the data (returns 0).'
          print,'   ERROR=err Error flag: 0=ok, 1=constant array, 2=other.'
          print,'     For a constant array alo and ahi are returned as -1.'
