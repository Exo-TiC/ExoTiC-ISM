...
;-
;-------------------------------------------------------------
	function ell_geo_mid, p1, p2, azi1=a1, azi2=a2, mdist=mdist, help=hlp
	...
	if (n_params(0) lt 2) or keyword_set(hlp) then begin
	  ...
	  print,'   MDIST=mdist midpoint distance to p1 or p2 (m).'
          return,''
        endif
...
;	ell_rb2ll, p1.lon,p1.lat, d/2D0, a1, lonm, latm, a2  ; Go halfway.
	ell_rb2ll, p1.lon,p1.lat, mdist, a1, lonm, latm, a2  ; Go halfway.
