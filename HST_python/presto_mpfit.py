"""
Yet another Python version of mpfit.
This one is from the package presto, specifically from the #90 PR on the branch "python3new":
https://github.com/scottransom/presto/blob/python3new/lib/python/mpfit.py
"""
